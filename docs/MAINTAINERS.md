...
> **National legislation** is the hard case (non-English authentic texts, gazette sourcing, per-country licensing, faithful reproduction of official defects, and the translation-to-derived rule). It has its own operating guide: [`docs/national-law-guide.md`](national-law-guide.md). Read it before ingesting a national instrument.
