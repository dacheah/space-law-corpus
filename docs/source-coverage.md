...
| **Authentic languages** | **Determined per treaty by that treaty's own final clause — not uniform across the five.** Verified against the stored authentic texts (2026-07-25): the **Outer Space Treaty (1967)**, **Rescue Agreement (1968)** and **Liability Convention (1972)** declare *English, Russian, French, Spanish and Chinese* equally authentic (five languages; deposited with the three Depositary Governments). The **Registration Convention (1975)** and **Moon Agreement (1979)** declare *Arabic, Chinese, English, French, Russian and Spanish* equally authentic (six languages; deposited with the UN Secretary-General) — for these two, Arabic **is** an authentic text, reflecting Arabic having become an official UN language in 1973. An earlier draft of this report asserted a blanket five-language rule and that Arabic is never authentic; that was wrong for the two later treaties and is corrected here. Where a language version is a *later translation* rather than an authentic text, it belongs in the derived layer. |
