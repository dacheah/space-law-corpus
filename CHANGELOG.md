...
- Verify the `extracted_unverified` texts: the two soft-law guidelines, and the three national laws — in particular the Luxembourg text against its Journal officiel PDF (HTML spacing defects) and the France consolidated text against its Légifrance PDF (line-wrap hyphenation artifacts, e.g. "extraatmosphérique").
