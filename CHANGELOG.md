...
- Verify the `extracted_unverified` texts: the two soft-law guidelines, and the two national laws — in particular check the Luxembourg text against the Journal officiel PDF (the official HTML has spacing defects).
- Complete the national pilot (France; a derived English machine-draft of the Luxembourg law; the national-law handling guide).
